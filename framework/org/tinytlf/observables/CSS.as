...
package org.tinytlf.observables
{
	...
	public class CSS extends Values
	{
		 ...
		 * right).
		 *
		 * @returns An <code>IValues</code> instance, with properties that
		 * represent a flattened list of all cascading styles defined by the
		 * style path.
		 */
		public function lookup(path:String):Values
		{
		...
		//	div a#id:active
		//	div a.class:active
		private function internalLookup(path:String):Values
		{
			const merged:Values = new MergedValues();
//			const merged:Values = new Values();
		...
		override public function clearStyles():Values
		{
			Cache.clearStyles();
...
internal class StyleLink extends Values
{
	...
	public function mergeStyles(object:Object):Values
	{
	...
	public function applyStyles(destination:Object, dynamic:Boolean = false):Values
	{
		styleNames.
...
internal class MergedValues extends Values
{
	override flash_proxy function setProperty(name:*, value:*):void
	{
		if(value is String) {
...
internal class StyleName extends Values
{
	////
...
internal class Cache
{
	...
	public static function getStyle(lookup:String):Values
	{
		return styleCache[lookup];
	}
	
	public static function cacheStyle(path:String, style:Values):Values
	{
